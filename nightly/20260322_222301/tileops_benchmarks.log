...
823 passed, 834 warnings in 2571.75s (0:42:51)

===== profile_run.log summary =====
# TileOPs Benchmark Report
Generated: 2026-03-22 19:39:39
...
| --- | --- | --- | --- | --- |
| 1000 | 22.24 | 0.00 | 0.00 | 0.00 |
| 2000 | 24.4 | 0.00 | 0.00 | 0.00 |
| 4000 | 20.71 | 0.00 | 0.00 | 0.01 |
| 8000 | 21.81 | 0.00 | 0.00 | 0.02 |
| 16000 | 20.38 | 0.00 | 0.01 | 0.03 |
| 32000 | 22.56 | 0.00 | 0.02 | 0.06 |
| 64000 | 21.98 | 0.00 | 0.03 | 0.12 |
| 128000 | 21.03 | 0.00 | 0.06 | 0.23 |
| 256000 | 21.44 | 0.00 | 0.11 | 0.45 |
| 512000 | 21.99 | 0.00 | 0.19 | 0.77 |
...
| 16777216 | 16M | torch.float16 | explicit_parallel | 0.02 | 0.80 | 3.18 |
...
| --- | --- | --- | --- | --- | --- | --- |
| 1024 | 4096 | torch.float16 | argmax | 3.08 | 0.00 | 0.00 |
| 1024 | 4096 | torch.bfloat16 | argmax | 3.08 | 0.00 | 0.00 |
| 4096 | 4096 | torch.float16 | argmax | 10.68 | 0.00 | 0.00 |
...
| op_name | dtype | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- |
| gt | torch.float16 | 0.01 | 0.52 | 2.58 |
...
| op_name | dtype | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- |
| ge | torch.float16 | 0.01 | 0.51 | 2.57 |
...
| sub | torch.float16 | 0.01 | 0.75 | 3.00 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 128 | 1024 | 2048 | 512 | 64 | 2048 | 1 | 1 | 1024 | torch.float16 | 1.16 | 502.91 | 0.25 |
| 1 | 128 | 512 | 4096 | 512 | 64 | 1024 | 1 | 1 | 512 | torch.float16 | 0.31 | 467.78 | 0.48 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 32 | 128 | 1 | 8192 | 512 | 64 | torch.float16 | 0.17 | 439.10 | 1.84 |
| 16 | 128 | 1 | 4096 | 512 | 64 | torch.float16 | 0.05 | 372.72 | 1.59 |

### baseline

| batch | heads | heads_kv | seq_len_kv | dim | dim_pe | dtype | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 32 | 128 | 1 | 8192 | 512 | 64 | torch.float16 | 0.72 | 101.09 | 0.42 |
| 16 | 128 | 1 | 4096 | 512 | 64 | torch.float16 | 0.19 | 95.73 | 0.41 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 9 | 8192 | 32 | 128 | 128 | 16 | 0.08838834764831845 | 32 | 32 | 128 | 128 | torch.float16 | torch.float32 | 0.32 | 54.21 | 6.99 |
| 16 | 16384 | 32 | 128 | 128 | 16 | 0.08838834764831845 | 32 | 32 | 128 | 128 | torch.float16 | torch.float32 | 0.35 | 198.44 | 25.19 |
...
| 16 | 16384 | 32 | 128 | 128 | 16 | 0.08838834764831845 | 32 | 32 | 128 | 128 | torch.float16 | torch.float32 | 591.83 | 0.12 | 0.01 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 16 | 1024 | 64 | True | 0.1 | 32 | 16 | 1 | torch.float16 | torch.float32 | 0.01 | 14.92 | 0.50 |
| 4 | 16 | 8192 | 64 | True | 0.1 | 32 | 16 | 1 | torch.float16 | torch.float32 | 0.04 | 28.15 | 0.94 |
| 2 | 16 | 8192 | 64 | True | 0.1 | 32 | 16 | 4 | torch.float16 | torch.float32 | 0.06 | 77.69 | 0.65 |

### baseline

| batch | heads | c_seq_len | dim | is_causal | scale | block_size | groups | selected_blocks | dtype | accum_dtype | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 16 | 1024 | 64 | True | 0.1 | 32 | 16 | 1 | torch.float16 | torch.float32 | 64.92 | 0.00 | 0.00 |
| 4 | 16 | 8192 | 64 | True | 0.1 | 32 | 16 | 1 | torch.float16 | torch.float32 | 518.95 | 0.00 | 0.00 |
| 2 | 16 | 8192 | 64 | True | 0.1 | 32 | 16 | 4 | torch.float16 | torch.float32 | 478.75 | 0.01 | 0.00 |
...
| 9 | 8192 | 32 | 128 | 16 | 1 | 16 | 32 | 32 | 128 | torch.float16 | torch.float32 | 0.37 | 46.48 | 3.09 |

### baseline

| seq_num | c_seq_len | heads | dim | group | scale | selected_block_num | bc | bs | bk | dtype | accum_dtype | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 5 | 1024 | 32 | 128 | 16 | 1 | 16 | 32 | 32 | 128 | torch.float16 | torch.float32 | 240.33 | 0.00 | 0.00 |
| 3 | 512 | 32 | 128 | 16 | 1 | 16 | 32 | 32 | 128 | torch.float16 | torch.float32 | 119.53 | 0.00 | 0.00 |
| 9 | 8192 | 32 | 128 | 16 | 1 | 16 | 32 | 32 | 128 | torch.float16 | torch.float32 | 2493.41 | 0.01 | 0.00 |
...
| torch.float16 | 20971520 | 0.02 | 0.95 | 3.78 |
| torch.bfloat16 | 20971520 | 0.02 | 0.95 | 3.78 |
| torch.float32 | 20971520 | 0.04 | 0.51 | 4.09 |
...
| exp_fp8 | 67108864 | torch.float8_e4m3fn | 0.05 | 1.32 | 2.64 |
...
| add_fp8 | 134217728 | torch.float8_e4m3fn | 1.08 | 0.12 | 0.37 |
...
| silu_and_mul_fp8 | 16384 | 11008 | torch.float8_e4m3fn | 2.03 | 0.44 | 0.27 |
| silu_and_mul_fp8 | 16384 | 11008 | torch.float8_e5m2 | 1.98 | 0.46 | 0.27 |
| silu_and_mul_fp8 | 16384 | 28672 | torch.float8_e4m3fn | 4.20 | 0.56 | 0.34 |
| silu_and_mul_fp8 | 16384 | 28672 | torch.float8_e5m2 | 4.12 | 0.57 | 0.34 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 8192 | 1 | 64 | torch.float16 | 0.00 | 1.03 | 0.34 |
...
| 2 | 32768 | 4 | 64 | 64 | 64 | torch.float16 | 1.03 | 2.09 | 0.13 |
| 2 | 2048 | 4 | 64 | 64 | 64 | torch.bfloat16 | 0.08 | 1.64 | 0.10 |
| 2 | 4096 | 4 | 64 | 64 | 64 | torch.bfloat16 | 0.14 | 1.94 | 0.12 |
| 2 | 8192 | 4 | 64 | 64 | 64 | torch.bfloat16 | 0.29 | 1.87 | 0.12 |
...
| batch | seq_len | heads | dim_k | dim_v | chunk_size | dtype | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2 | 4096 | 4 | 64 | 64 | 32 | torch.float16 | 131.23 | 0.00 | 0.00 |
| 2 | 4096 | 4 | 64 | 64 | 32 | torch.bfloat16 | 132.14 | 0.00 | 0.00 |
| 2 | 2048 | 4 | 64 | 64 | 64 | torch.float16 | 45.43 | 0.00 | 0.00 |
| 2 | 4096 | 4 | 64 | 64 | 64 | torch.float16 | 90.87 | 0.00 | 0.00 |
| 2 | 8192 | 4 | 64 | 64 | 64 | torch.float16 | 182.11 | 0.00 | 0.00 |
| 2 | 16384 | 4 | 64 | 64 | 64 | torch.float16 | 364.90 | 0.00 | 0.00 |
| 2 | 32768 | 4 | 64 | 64 | 64 | torch.float16 | 728.92 | 0.00 | 0.00 |
| 2 | 2048 | 4 | 64 | 64 | 64 | torch.bfloat16 | 45.38 | 0.00 | 0.00 |
| 2 | 4096 | 4 | 64 | 64 | 64 | torch.bfloat16 | 90.66 | 0.00 | 0.00 |
| 2 | 8192 | 4 | 64 | 64 | 64 | torch.bfloat16 | 182.16 | 0.00 | 0.00 |
| 2 | 16384 | 4 | 64 | 64 | 64 | torch.bfloat16 | 366.89 | 0.00 | 0.00 |
| 2 | 32768 | 4 | 64 | 64 | 64 | torch.bfloat16 | 730.13 | 0.00 | 0.00 |
...
| 2 | 16384 | 4 | 64 | 64 | 64 | torch.float16 | 2 | 4 | 16384 | 64 | 64 | 64 | 1.20 | 1.79 | 0.10 |
...
| batch | seq_len | heads | dim_k | dim_v | chunk_size | dtype | B | H | S | DK | DV | BC | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2 | 4096 | 4 | 64 | 64 | 32 | torch.float16 | 2 | 4 | 4096 | 64 | 64 | 32 | 50.01 | 0.01 | 0.00 |
| 2 | 4096 | 4 | 64 | 64 | 32 | torch.bfloat16 | 2 | 4 | 4096 | 64 | 64 | 32 | 49.93 | 0.01 | 0.00 |
| 2 | 2048 | 4 | 64 | 64 | 64 | torch.float16 | 2 | 4 | 2048 | 64 | 64 | 64 | 19.41 | 0.01 | 0.00 |
| 2 | 4096 | 4 | 64 | 64 | 64 | torch.float16 | 2 | 4 | 4096 | 64 | 64 | 64 | 39.75 | 0.01 | 0.00 |
| 2 | 8192 | 4 | 64 | 64 | 64 | torch.float16 | 2 | 4 | 8192 | 64 | 64 | 64 | 82.63 | 0.01 | 0.00 |
| 2 | 16384 | 4 | 64 | 64 | 64 | torch.float16 | 2 | 4 | 16384 | 64 | 64 | 64 | 175.47 | 0.01 | 0.00 |
| 2 | 2048 | 4 | 64 | 64 | 64 | torch.bfloat16 | 2 | 4 | 2048 | 64 | 64 | 64 | 19.41 | 0.01 | 0.00 |
| 2 | 4096 | 4 | 64 | 64 | 64 | torch.bfloat16 | 2 | 4 | 4096 | 64 | 64 | 64 | 39.69 | 0.01 | 0.00 |
| 2 | 8192 | 4 | 64 | 64 | 64 | torch.bfloat16 | 2 | 4 | 8192 | 64 | 64 | 64 | 82.58 | 0.01 | 0.00 |
| 2 | 16384 | 4 | 64 | 64 | 64 | torch.bfloat16 | 2 | 4 | 16384 | 64 | 64 | 64 | 175.54 | 0.01 | 0.00 |
...
| batch | seq_len | heads | dim_k | dim_v | chunk_size | dtype | B | H | S | DK | DV | BC | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2 | 4096 | 4 | 64 | 64 | 32 | torch.float16 | 2 | 4 | 4096 | 64 | 64 | 32 | 49.96 | 0.02 | 0.00 |
| 2 | 4096 | 4 | 64 | 64 | 32 | torch.bfloat16 | 2 | 4 | 4096 | 64 | 64 | 32 | 50.06 | 0.02 | 0.00 |
| 2 | 2048 | 4 | 64 | 64 | 64 | torch.float16 | 2 | 4 | 2048 | 64 | 64 | 64 | 19.41 | 0.02 | 0.00 |
| 2 | 4096 | 4 | 64 | 64 | 64 | torch.float16 | 2 | 4 | 4096 | 64 | 64 | 64 | 39.70 | 0.02 | 0.00 |
| 2 | 8192 | 4 | 64 | 64 | 64 | torch.float16 | 2 | 4 | 8192 | 64 | 64 | 64 | 82.59 | 0.02 | 0.00 |
| 2 | 16384 | 4 | 64 | 64 | 64 | torch.float16 | 2 | 4 | 16384 | 64 | 64 | 64 | 175.48 | 0.02 | 0.00 |
| 2 | 2048 | 4 | 64 | 64 | 64 | torch.bfloat16 | 2 | 4 | 2048 | 64 | 64 | 64 | 19.41 | 0.02 | 0.00 |
| 2 | 4096 | 4 | 64 | 64 | 64 | torch.bfloat16 | 2 | 4 | 4096 | 64 | 64 | 64 | 39.70 | 0.02 | 0.00 |
| 2 | 8192 | 4 | 64 | 64 | 64 | torch.bfloat16 | 2 | 4 | 8192 | 64 | 64 | 64 | 82.57 | 0.02 | 0.00 |
| 2 | 16384 | 4 | 64 | 64 | 64 | torch.bfloat16 | 2 | 4 | 16384 | 64 | 64 | 64 | 175.53 | 0.02 | 0.00 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1024 | 1024 | 1024 | torch.float16 | False | False | 0.01 | 239.75 | 0.70 |
...
| m | n | k | dtype | trans_a | trans_b | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1024 | 1024 | 1024 | torch.float16 | False | False | 0.01 | 323.04 | 0.95 |
| 1 | 7168 | 16384 | torch.float16 | False | True | 0.07 | 3.42 | 3.42 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2 | 2048 | 4 | 64 | 64 | 64 | torch.float16 | 0.125 | 0.08 | 1.72 | 0.11 |
...
| 2 | 16384 | 4 | 64 | 64 | 64 | torch.bfloat16 | 0.125 | 0.51 | 2.12 | 0.13 |
...
| 2 | 16384 | 4 | 64 | 64 | 64 | torch.float16 | 0.125 | 16.22 | 0.07 | 0.00 |
| 2 | 2048 | 4 | 64 | 64 | 64 | torch.bfloat16 | 0.125 | 2.00 | 0.07 | 0.00 |
| 2 | 4096 | 4 | 64 | 64 | 64 | torch.bfloat16 | 0.125 | 4.06 | 0.07 | 0.00 |
| 2 | 8192 | 4 | 64 | 64 | 64 | torch.bfloat16 | 0.125 | 8.12 | 0.07 | 0.00 |
| 2 | 16384 | 4 | 64 | 64 | 64 | torch.bfloat16 | 0.125 | 16.21 | 0.07 | 0.00 |
...
| 2 | 16384 | 4 | 64 | 64 | 64 | torch.bfloat16 | 2 | 16384 | 4 | 64 | 64 | 64 | 0.125 | 1.11 | 1.93 | 0.11 |
...
| 2 | 16384 | 4 | 64 | 64 | 64 | torch.float16 | 2 | 16384 | 4 | 64 | 64 | 64 | 0.125 | 70.33 | 0.03 | 0.00 |
| 2 | 2048 | 4 | 64 | 64 | 64 | torch.bfloat16 | 2 | 2048 | 4 | 64 | 64 | 64 | 0.125 | 5.89 | 0.05 | 0.00 |
| 2 | 4096 | 4 | 64 | 64 | 64 | torch.bfloat16 | 2 | 4096 | 4 | 64 | 64 | 64 | 0.125 | 12.54 | 0.04 | 0.00 |
| 2 | 8192 | 4 | 64 | 64 | 64 | torch.bfloat16 | 2 | 8192 | 4 | 64 | 64 | 64 | 0.125 | 28.67 | 0.04 | 0.00 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2 | 2048 | 4 | 64 | 64 | 64 | torch.float16 | 2048 | 2 | 64 | 4 | 64 | 64 | 0.125 | 0.23 | 1.77 | 0.10 |
| 2 | 4096 | 4 | 64 | 64 | 64 | torch.float16 | 4096 | 2 | 64 | 4 | 64 | 64 | 0.125 | 0.43 | 1.86 | 0.11 |
...
| 2 | 16384 | 4 | 64 | 64 | 64 | torch.bfloat16 | 16384 | 2 | 64 | 4 | 64 | 64 | 0.125 | 1.54 | 2.10 | 0.12 |

### baseline

| batch | seq_len | heads | dim_k | dim_v | chunk_size | dtype | T | B | BC | H | K | V | scale | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2 | 2048 | 4 | 64 | 64 | 64 | torch.float16 | 2048 | 2 | 64 | 4 | 64 | 64 | 0.125 | 5.99 | 0.07 | 0.00 |
| 2 | 4096 | 4 | 64 | 64 | 64 | torch.float16 | 4096 | 2 | 64 | 4 | 64 | 64 | 0.125 | 12.57 | 0.06 | 0.00 |
| 2 | 8192 | 4 | 64 | 64 | 64 | torch.float16 | 8192 | 2 | 64 | 4 | 64 | 64 | 0.125 | 28.68 | 0.06 | 0.00 |
| 2 | 16384 | 4 | 64 | 64 | 64 | torch.float16 | 16384 | 2 | 64 | 4 | 64 | 64 | 0.125 | 70.38 | 0.05 | 0.00 |
| 2 | 2048 | 4 | 64 | 64 | 64 | torch.bfloat16 | 2048 | 2 | 64 | 4 | 64 | 64 | 0.125 | 5.89 | 0.07 | 0.00 |
| 2 | 4096 | 4 | 64 | 64 | 64 | torch.bfloat16 | 4096 | 2 | 64 | 4 | 64 | 64 | 0.125 | 12.58 | 0.06 | 0.00 |
| 2 | 8192 | 4 | 64 | 64 | 64 | torch.bfloat16 | 8192 | 2 | 64 | 4 | 64 | 64 | 0.125 | 28.64 | 0.06 | 0.00 |
| 2 | 16384 | 4 | 64 | 64 | 64 | torch.bfloat16 | 16384 | 2 | 64 | 4 | 64 | 64 | 0.125 | 70.41 | 0.05 | 0.00 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 1024 | 8 | 4 | 64 | False | torch.float16 | 0.01 | 209.01 | 0.31 |
| 4 | 2048 | 64 | 4 | 128 | False | torch.float16 | 0.83 | 661.70 | 0.34 |
| 4 | 2048 | 64 | 4 | 128 | False | torch.bfloat16 | 0.81 | 682.02 | 0.35 |
...
| batch | seq_len | heads | heads_kv | dim | causal | dtype | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 1024 | 8 | 4 | 64 | False | torch.float16 | 0.05 | 102.10 | 0.10 |
| 4 | 2048 | 64 | 4 | 128 | False | torch.float16 | 3.57 | 385.42 | 0.12 |
| 4 | 2048 | 64 | 4 | 128 | False | torch.bfloat16 | 3.43 | 400.51 | 0.13 |
...
| 4 | 32 | 4 | 4096 | 128 | torch.bfloat16 | 0.04 | 6.72 | 0.84 |
| 8 | 64 | 16 | 8192 | 128 | torch.float16 | 0.17 | 12.91 | 3.23 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2 | 512 | 8 | 2 | 64 | True | -1 | -1 | torch.float16 | 0.01 | 71.56 | 0.35 |
| 2 | 512 | 8 | 2 | 64 | True | 128 | -1 | torch.float16 | 0.01 | 41.53 | 0.46 |
| 2 | 768 | 8 | 2 | 64 | False | 256 | -1 | torch.float16 | 0.01 | 149.99 | 0.31 |
| 2 | 512 | 8 | 2 | 64 | False | 64 | 64 | torch.bfloat16 | 0.01 | 43.90 | 0.45 |
| 1 | 2048 | 8 | 2 | 64 | True | 512 | -1 | torch.float16 | 0.01 | 151.34 | 0.42 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 32 | 8 | 128 | True | -1 | -1 | torch.float16 | 3000 | 0.22 | 341.70 | 0.28 |
| 2 | 32 | 8 | 128 | True | 2000 | -1 | torch.float16 | 3073 | 0.34 | 253.70 | 0.27 |
| 4 | 32 | 8 | 128 | False | 1500 | 1500 | torch.float16 | 3500 | 0.91 | 376.48 | 0.22 |
| 2 | 32 | 8 | 128 | True | -1 | -1 | torch.float16 | 1024 | 0.39 | 407.86 | 0.19 |
| 2 | 32 | 8 | 128 | True | -1 | -1 | torch.float16 | 8193 | 1.92 | 392.32 | 0.14 |
...
| 8 | 128 | 32 | torch.bfloat16 | 0.01 | 0.36 | 0.28 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| grouped_gemm_nt | 16384 | 4 | 4864 | 4096 | torch.float16 | False | True | 1.08 | 605.88 | 0.42 |

### baseline

| name | batch_sum | batch_count | N | K | dtype | transpose_a | transpose_b | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| grouped_gemm_nt | 16384 | 4 | 4864 | 4096 | torch.float16 | False | True | 1.63 | 399.65 | 0.28 |
...
| name | batch_sum | batch_count | N | K | dtype | transpose_a | transpose_b | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| grouped_gemm_nn | 16384 | 4 | 4864 | 4096 | torch.float16 | False | False | 1.11 | 585.67 | 0.41 |

### baseline

| name | batch_sum | batch_count | N | K | dtype | transpose_a | transpose_b | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| grouped_gemm_nn | 16384 | 4 | 4864 | 4096 | torch.float16 | False | False | 1.16 | 564.99 | 0.39 |
...
| name | batch_sum | batch_count | N | K | dtype | transpose_a | transpose_b | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| grouped_gemm_tn | 16384 | 4 | 4864 | 4096 | torch.float16 | True | False | 9.30 | 70.21 | 0.05 |

### baseline

| name | batch_sum | batch_count | N | K | dtype | transpose_a | transpose_b | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| grouped_gemm_tn | 16384 | 4 | 4864 | 4096 | torch.float16 | True | False | 1.02 | 641.92 | 0.45 |
...
| name | batch_sum | batch_count | N | K | dtype | transpose_a | transpose_b | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| grouped_gemm_tt | 16384 | 4 | 4864 | 4096 | torch.float16 | True | True | 9.10 | 71.75 | 0.05 |

### baseline

| name | batch_sum | batch_count | N | K | dtype | transpose_a | transpose_b | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| grouped_gemm_tt | 16384 | 4 | 4864 | 4096 | torch.float16 | True | True | 1.02 | 638.53 | 0.44 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 16384 | 4 | 4864 | 4096 | torch.float16 | True | False | 20.62 | 94.98 | N/A |

### baseline

| batch_sum | batch_count | N | K | dtype | transpose_a | transpose_b | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 16384 | 4 | 4864 | 4096 | torch.float16 | True | False | 4.88 | 401.35 | N/A |
...
| --- | --- | --- | --- | --- | --- |
| leaky_relu | torch.float16 | 4194304 | 0.01 | 0.68 | 2.74 |
...
| leaky_relu | torch.float16 | 10485760 | 0.01 | 0.85 | 3.38 |
...
| elu | torch.float16 | 10485760 | 0.01 | 0.80 | 3.18 |
...
| elu | torch.bfloat16 | 20971520 | 0.02 | 0.89 | 3.58 |
...
| elu | torch.bfloat16 | 4194304 | 0.01 | 0.43 | 1.71 |
...
| hardtanh | torch.bfloat16 | 20971520 | 0.02 | 0.90 | 3.61 |
...
| hardtanh | torch.float32 | 20971520 | 0.04 | 0.50 | 4.04 |
...
| op_name | dtype | n_total | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- |
| softplus | torch.float16 | 4194304 | 0.01 | 0.41 | 1.65 |
| softplus | torch.bfloat16 | 4194304 | 0.01 | 0.40 | 1.62 |
...
| clamp | torch.float32 | 20971520 | 0.04 | 0.50 | 4.04 |
...
| 10240 | torch.float16 | 10485760 | 0.01 | 0.81 | 3.25 |
| 10240 | torch.bfloat16 | 10485760 | 0.01 | 0.81 | 3.24 |
| 10240 | torch.float32 | 10485760 | 0.02 | 0.47 | 3.77 |
...
| dtype | n_total | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- |
| torch.float16 | 4194304 | 0.01 | 0.55 | 2.74 |
| torch.bfloat16 | 4194304 | 0.01 | 0.55 | 2.74 |
| torch.float32 | 4194304 | 0.01 | 0.35 | 3.12 |
...
| alibi | 2048 | 64 | torch.bfloat16 | 0.27 | 0.99 | 1.97 |
| alibi | 2048 | 64 | torch.float32 | 0.26 | 1.05 | 4.18 |
| alibi | 4096 | 128 | torch.float16 | 0.88 | 2.43 | 4.86 |
...
| alibi | 4096 | 128 | torch.float16 | 8.17 | 0.26 | 0.53 |
| alibi | 4096 | 128 | torch.bfloat16 | 8.17 | 0.26 | 0.53 |
...
| leaky_relu | torch.float8_e4m3fn | 20971520 | 0.03 | 0.62 | 1.23 |
...
| elu | torch.float8_e4m3fn | 10485760 | 0.01 | 0.85 | 1.69 |
...
| op_name | dtype | n_total | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- |
| where | torch.float8_e4m3fn | 4194304 | 0.01 | 0.51 | 2.02 |
| where | torch.float8_e5m2 | 4194304 | 0.01 | 0.51 | 2.02 |
| where | torch.float8_e4m3fn | 10485760 | 0.02 | 0.57 | 2.27 |
| where | torch.float8_e5m2 | 10485760 | 0.02 | 0.57 | 2.28 |
| where | torch.float8_e4m3fn | 20971520 | 0.03 | 0.64 | 2.57 |
| where | torch.float8_e5m2 | 20971520 | 0.03 | 0.64 | 2.57 |
...
| masked_fill | torch.float8_e4m3fn | 10485760 | 0.01 | 0.75 | 2.24 |
...
| 2048 | 5120 | torch.float16 | 0.03 | 2.03 | 1.63 |
...
| 4096 | 4096 | torch.bfloat16 | 0.03 | 2.57 | 2.06 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 1024 | 8 | 64 | False | torch.float16 | 0.01 | 205.74 | 0.40 |
| 16 | 2048 | 16 | 128 | False | torch.float16 | 0.85 | 648.21 | 0.63 |
| 4 | 4096 | 16 | 128 | False | torch.bfloat16 | 0.79 | 693.03 | 0.34 |
...
| batch | seq_len | heads | dim | causal | dtype | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 1024 | 8 | 64 | False | torch.float16 | 0.04 | 125.25 | 0.17 |
| 16 | 2048 | 16 | 128 | False | torch.float16 | 2.87 | 479.55 | 0.33 |
| 4 | 4096 | 16 | 128 | False | torch.bfloat16 | 2.71 | 506.52 | 0.17 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 32 | 128 | 8192 | 128 | torch.float16 | 0.06 | 292.94 | 2.32 |
| 1 | 32 | 128 | 8192 | 128 | torch.bfloat16 | 0.06 | 293.10 | 2.33 |
...
| b | h | s_q | s_kv | d | dtype | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 32 | 128 | 8192 | 128 | torch.float16 | 0.07 | 257.15 | 2.04 |
| 1 | 32 | 128 | 8192 | 128 | torch.bfloat16 | 0.07 | 260.11 | 2.06 |
...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | 4 | 1280 | torch.bfloat16 | 0.00 | 28.01 | 0.01 |
| 2 | 4 | 1920 | torch.bfloat16 | 0.00 | 122.54 | 0.01 |
| 4 | 4 | 2560 | torch.bfloat16 | 0.00 | 414.55 | 0.01 |
...
| 2 | 4 | 1920 | torch.bfloat16 | 0.01 | 16.69 | 0.00 |
| 4 | 4 | 2560 | torch.bfloat16 | 0.01 | 56.24 | 0.00 |
...
| batch | n_expand | c_x | dtype | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- | --- |
| 1 | 4 | 1280 | torch.bfloat16 | 0.04 | 30.42 | 0.00 |
| 2 | 4 | 1920 | torch.bfloat16 | 0.05 | 103.13 | 0.00 |
| 4 | 4 | 2560 | torch.bfloat16 | 0.07 | 290.71 | 0.00 |
...
| 2 | 4 | 1920 | torch.bfloat16 | 0.30 | 18.74 | 0.00 |
| 4 | 4 | 2560 | torch.bfloat16 | 0.34 | 59.87 | 0.00 |
...
| total_tokens | top_k | num_experts | hidden_size | dtype | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 512 | 2 | 8 | 4096 | torch.bfloat16 | 0.01 | N/A | 0.87 |
| 2048 | 2 | 8 | 4096 | torch.bfloat16 | 0.04 | N/A | 1.43 |
| 4096 | 2 | 8 | 4096 | torch.bfloat16 | 0.07 | N/A | 1.44 |
| 512 | 8 | 256 | 7168 | torch.bfloat16 | 0.04 | N/A | 1.72 |
| 2048 | 8 | 256 | 7168 | torch.bfloat16 | 0.14 | N/A | 1.83 |
| 4096 | 8 | 256 | 7168 | torch.bfloat16 | 0.21 | N/A | 2.56 |
| 512 | 8 | 128 | 2048 | torch.bfloat16 | 0.03 | N/A | 0.73 |
| 2048 | 8 | 128 | 2048 | torch.bfloat16 | 0.10 | N/A | 0.78 |
| 4096 | 8 | 128 | 2048 | torch.bfloat16 | 0.14 | N/A | 1.10 |
...
| 4096 | 2 | 4096 | torch.bfloat16 | 0.03 | 2.31 | 3.47 |
| 512 | 8 | 7168 | torch.bfloat16 | 0.02 | 2.35 | 2.64 |
| 2048 | 8 | 7168 | torch.bfloat16 | 0.07 | 3.24 | 3.64 |
...
| 4096 | 8 | 2048 | torch.bfloat16 | 0.04 | 3.17 | 3.58 |
...
| 4096 | 8 | 7168 | torch.bfloat16 | 2.21 | 0.21 | 0.24 |
| 512 | 8 | 2048 | torch.bfloat16 | 0.10 | 0.16 | 0.19 |
| 2048 | 8 | 2048 | torch.bfloat16 | 0.36 | 0.19 | 0.21 |
| 4096 | 8 | 2048 | torch.bfloat16 | 0.69 | 0.19 | 0.22 |
...
| 1024 | 4096 | torch.bfloat16 | sum | 0.01 | 0.53 | 1.07 |
| 4096 | 4096 | torch.float16 | sum | 0.02 | 0.69 | 1.39 |
| 1024 | 4096 | torch.float16 | mean | 0.01 | 0.53 | 1.06 |
| 1024 | 4096 | torch.float16 | amax | 0.01 | 0.53 | 1.07 |
| 1024 | 4096 | torch.float16 | amin | 0.01 | 0.53 | 1.07 |
...
| 1024 | 4096 | torch.float16 | amin | 0.03 | 0.16 | 0.31 |
| 1024 | 4096 | torch.float16 | prod | 0.03 | 0.16 | 0.32 |
| 1024 | 4096 | torch.float16 | std | 0.04 | 0.32 | 0.22 |
| 1024 | 4096 | torch.float16 | var | 0.04 | 0.32 | 0.22 |
...
| m | n | dtype | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- |
| 1024 | 4096 | torch.float16 | 0.01 | 1.70 | 1.71 |
| 4096 | 4096 | torch.bfloat16 | 0.03 | 2.08 | 2.09 |
...
| 1025 | 4096 | torch.float16 | 0.02 | 1.00 | 0.80 |

### baseline

| m | n | dtype | latency_ms | tflops | bandwidth_tbs |
| --- | --- | --- | --- | --- | --- |
| 1024 | 4096 | torch.float16 | 0.02 | 1.37 | 1.09 |
| 4096 | 4096 | torch.bfloat16 | 0.05 | 1.59 | 1.27 |
| 1024 | 3000 | torch.float16 | 0.01 | 1.15 | 0.92 |
| 1025 | 4096 | torch.float16 | 0.02 | 1.37 | 1.09 |
...
| 1 | 65535 | 131072 | 1 | 1024 | torch.float32 | torch.int32 | 44.57 | N/A | 0.78 |
...
| 1 | 32768 | 65536 | 1 | 2048 | torch.float32 | torch.int32 | 14.90 | N/A | 0.59 |
| 1 | 65535 | 131072 | 1 | 1024 | torch.float32 | torch.int32 | 109.39 | N/A | 0.32 |
| 1 | 65535 | 131072 | 1 | 2048 | torch.float32 | torch.int32 | 112.14 | N/A | 0.31 |
...
| gelu | 4000000 | torch.float16 | torch.float16 | 0.01 | 0.50 | 1.99 |
...
| 4194304 | 1024x4096 | torch.float32 | direct | 0.02 | 0.26 | 2.12 |
...
| 10485760 | 1024x10240 | torch.bfloat16 | explicit_parallel | 0.01 | 0.75 | 3.02 |
...
| 20971520 | 1024x20480 | torch.float32 | register_copy | 0.04 | 0.52 | 4.12 |
...
| 1024 | 4096 | torch.bfloat16 | l1 | 0.01 | 0.53 | 1.07 |
| 1024 | 4096 | torch.float32 | l1 | 0.01 | 0.34 | 1.37 |
| 4096 | 4096 | torch.float16 | l1 | 0.02 | 0.69 | 1.38 |
| 1024 | 4096 | torch.float16 | l2 | 0.01 | 0.52 | 1.05 |
...
| 4096 | 4096 | torch.float16 | l2 | 0.02 | 0.76 | 1.51 |
